...
class collada_file:
    ...
    def set_normal_buffer(normal_buffer, count):

    def set_vertex_buffer(vertex_buffer, count):

    def set_color_buffer(color_buffer, count):

    def set_face_buffer(face_buffer, count):


    def set_bone_name_buffer(bone_name_buffer, count):


    def set_vertex_weight_buffer(vertex_weight_index_buffer, vertex_weight_buffer):



    def set_bind_pose_index(bind_pose_index, count):
